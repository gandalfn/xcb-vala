...
init ()
{
    XCBVala.XmlObject.register_object ("doc",         typeof (XCBVala.Doc));
    XCBVala.XmlObject.register_object ("brief",       typeof (XCBVala.Brief));
    XCBVala.XmlObject.register_object ("description", typeof (XCBVala.Description));
    XCBVala.XmlObject.register_object ("see",         typeof (XCBVala.See));
    XCBVala.XmlObject.register_object ("import",      typeof (XCBVala.Import));
    XCBVala.XmlObject.register_object ("xcb",         typeof (XCBVala.Root));
    XCBVala.XmlObject.register_object ("struct",      typeof (XCBVala.Struct));
    ...
    XCBVala.XmlObject.register_object ("bitcase",     typeof (XCBVala.Bitcase));
    XCBVala.XmlObject.register_object ("switch",      typeof (XCBVala.Switch));
    ...
    XCBVala.XmlObject.register_object ("op",          typeof (XCBVala.OP));
}
